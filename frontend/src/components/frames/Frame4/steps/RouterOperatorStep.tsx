    ...
    <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col gap-[5px] pb-2">
          {operators.map((option) => {
            ...
            return (
              ...
              >
                <span style={{ fontFamily: 'TT Firs Neue, sans-serif', fontWeight: 400, fontSize: '16px', lineHeight: '125%', color: isSelected ? '#101010' : 'rgba(16, 16, 16, 0.5)' }}>
                  {option.label}
                </span>
                <div
                  className="w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0"
                  style={{ boxSizing: 'border-box', border: isSelected ? 'none' : '1px solid rgba(16, 16, 16, 0.5)', background: isSelected ? '#101010' : 'transparent' }}
                >
                  {isSelected && (
      ...
      <div className="flex-shrink-0 flex items-center gap-[5px] px-[15px] pb-[15px] pt-[10px]">
        <button
          ...
          style={{
            width: '50px', height: '50px', border: '1px solid rgba(16, 16, 16, 0.25)', background: 'transparent', boxSizing: 'border-box',
            transform: isBackPressed ? 'scale(0.92)' : 'scale(1)', transition: 'transform 0.15s ease-out',
          }}
        >
