...
export interface ApplicationCreationAttributes
  extends Optional<ApplicationAttributes, 'id' | 'userId' | 'email' | 'status' | 'building' | 'apartment' | 'entrance' | 'floor' | 'intercom' | 'preferredDate' | 'preferredTimeFrom' | 'preferredTimeTo' | 'comment' | 'source' | 'utmSource' | 'utmMedium' | 'utmCampaign' | 'utmContent' | 'utmTerm' | 'assignedTo' | 'internalComment'> {}
