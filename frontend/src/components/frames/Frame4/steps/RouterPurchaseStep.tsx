...
interface RouterPurchaseStepProps {
  ...
  onSelect: (option: RouterPurchaseOption) => void;
  onNext: () => void;
  onBack: () => void;
}

const options: { value: RouterPurchaseOption; label: string }[] = [
  { value: 'buy', label: 'Покупка за 6969 р.' },
...
export default function RouterPurchaseStep({
  selected,
  onSelect,
  onNext,
  onBack,
