...
export default function TvBoxNeedStep({
  ...
  const isNextDisabled = selected === 'have_own';
    ...
    <div className="flex flex-col w-full">
      ...
      <div className="flex-shrink-0 flex items-center gap-[5px] px-[15px] pb-[15px] pt-[10px]">
        ...
        <button
          ...
          className="outline-none flex-1 rounded-[10px] flex items-center justify-center text-center min-h-[50px] disabled:cursor-not-allowed"
          style={{
            boxSizing: 'border-box',
            background: '#101010',
            border: '1px solid rgba(16, 16, 16, 0.25)',
