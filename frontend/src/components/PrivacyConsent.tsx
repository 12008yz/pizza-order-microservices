...
export default function PrivacyConsent() {
  ...
  return (
    <div
      className={`relative w-full border rounded-[10px] bg-white flex items-center p-4 cursor-pointer transition-all ${hasError ? 'border-red-500' : 'border-[rgba(16,16,16,0.25)]'
        }`}
